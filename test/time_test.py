...
from src.preprocess import time
...
class UtilTest(unittest.TestCase):
    ...
    def test_filter_by_time():
        ...
        filtered = time.select(df, 'time', from_time='2019-01-01', to_time='2019-01-30')
