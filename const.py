...
LD_GRID_FORECAST = 'LD_GRID_FORECAST'
LD_GRID_COARSE = 'LD_GRID_COARSE'
...
MEO_STEPS = 'MEO_STEPS'
MEO_GROUP = 'MEO_GROUP'
MEO_LONG_STEPS = 'MEO_LONG_STEPS'
MEO_LONG_GROUP = 'MEO_LONG_GROUP'
FUTURE_STEPS = 'FUTURE_STEPS'
FUTURE_GROUP = 'FUTURE_GROUP'
AIR_STEPS = 'AIR_STEPS'
AIR_GROUP = 'AIR_GROUP'
AIR_LONG_STEPS = 'AIR_LONG_STEPS'
AIR_LONG_GROUP = 'AIR_LONG_GROUP'
GRIDS = 'grids'
GRID_DATA = 'grid_data'
GRID_URL = 'grid_url'
GRID_LIVE = 'grid_live'
...
def func():
    ...
    global T_FORMAT
    global BJ, LD
    global FEATURE_DIR, BJ_PM25_, BJ_PM10_, BJ_O3_
    global LD_FEATURES, LD_PM25_, LD_PM10_, LD_O3_
    global POLLUTANT
    global EPOCHS, BATCH_SIZE, TIME_STEPS, CHUNK_COUNT, ROTATE
    global LOSS_FUNCTION, MEAN_ABSOLUTE, MEAN_PERCENT
    global TRAIN, TEST, VALID
    global MODEL, MODEL_DIR
    global MEO_STEPS, MEO_GROUP, FUTURE_STEPS, FUTURE_GROUP, AIR_STEPS, AIR_GROUP
    global MEO_LONG_STEPS, MEO_LONG_GROUP, AIR_LONG_STEPS, AIR_LONG_GROUP
    global GRIDS, GRID_DATA, GRID_LIVE, GRID_FORECAST, GRID_URL, BJ_GRIDS, BJ_GRID_DATA, BJ_AQ_URL, BJ_MEO_URL, BJ_GRID_URL
    global LD_GRIDS, LD_GRID_DATA, LD_GRID_URL, LD_AQ_URL, BJ_GRID_LIVE, BJ_GRID_FORECAST, LD_GRID_LIVE, LD_GRID_FORECAST
    global MNIST_FOLDER
    global SUBMIT_DIR
    global LEADERBOARD_JSON, CHROME_DRIVER_PATH
